...
import claude_monitor.cli.main as main_module
...
class TestMain:
    ...
    def test_json_output_mode_triggered(self, mock_load_settings: Mock) -> None:
        ...
        # Use manual patching for better Python version compatibility
        import sys
        actual_module = sys.modules["claude_monitor.cli.main"]
        
        original_json_output = actual_module._run_json_output
        original_monitoring = actual_module._run_monitoring
        
        mock_json_output = Mock(return_value=0)
        mock_monitoring = Mock()
        
        actual_module._run_json_output = mock_json_output
        actual_module._run_monitoring = mock_monitoring
        ...
        try:
            ...
            actual_module._run_json_output = original_json_output
            actual_module._run_monitoring = original_monitoring
    ...
    def test_normal_mode_when_no_json_flag(self, mock_load_settings: Mock) -> None:
        ...
        original_json_output = actual_module._run_json_output
        original_monitoring = actual_module._run_monitoring
        original_discover_paths = actual_module.discover_claude_data_paths
        
        mock_json_output = Mock()
        mock_monitoring = Mock()
        mock_discover_paths = Mock(return_value=[Path("/test/path")])
        
        actual_module._run_json_output = mock_json_output
        actual_module._run_monitoring = mock_monitoring
        actual_module.discover_claude_data_paths = mock_discover_paths
        ...
        try:
            ...
            actual_module._run_json_output = original_json_output
            actual_module._run_monitoring = original_monitoring
            actual_module.discover_claude_data_paths = original_discover_paths
...
class TestJsonOutput:
    ...
    def test_json_output_success(self) -> None:
        ...
        original_discover_paths = actual_module.discover_claude_data_paths
        original_analyze_usage = actual_module.analyze_usage
        ...
        mock_analyze_usage = Mock(return_value=mock_usage_data)
        
        actual_module.discover_claude_data_paths = mock_discover_paths
        actual_module.analyze_usage = mock_analyze_usage
        ...
        try:
            ...
            actual_module.discover_claude_data_paths = original_discover_paths
            actual_module.analyze_usage = original_analyze_usage

    def test_json_output_no_claude_data_directory(self) -> None:
        ...
        original_discover_paths = actual_module.discover_claude_data_paths
        mock_discover_paths = Mock(return_value=[])
        actual_module.discover_claude_data_paths = mock_discover_paths
    ...
    def test_json_output_analyze_usage_returns_none(self) -> None:
        ...
        mock_discover_paths = Mock(return_value=[Path("/test/path")])
        mock_analyze_usage = Mock(return_value=None)
    ...
    def test_json_output_with_exception(self) -> None:
        ...
        mock_discover_paths = Mock(return_value=[Path("/test/path")])
        mock_analyze_usage = Mock(side_effect=Exception("Test exception"))
    ...
    def test_json_output_with_custom_hours_back(self) -> None:
    ...
    def test_json_output_metadata_structure(self) -> None:
        ...
        mock_discover_paths = Mock(return_value=[Path("/custom/path")])
        mock_usage_data = {
            "blocks": [],
