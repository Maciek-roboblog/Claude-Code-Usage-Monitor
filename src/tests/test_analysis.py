...
class TestAnalyzeUsage:
    ...
    def test_analyze_usage_basic(
        self, mock_calc_class: Any, mock_analyzer_class: Any, mock_load: Any
    ) -> None:
...
class TestCreateResult:
    ...
    def test_create_result_basic(self, mock_convert: Any) -> None:
...
class TestBlockConversion:
    ...
    def test_convert_blocks_to_dict_format(
        self, mock_add_optional: Any, mock_create_base: Any
    ) -> None:
