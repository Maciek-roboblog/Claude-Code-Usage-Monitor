...
class TestGetTimeFormatPreference:
    ...
    def test_get_time_format_preference_no_args(self, mock_get_pref: Any) -> None:
    ...
    @patch("claude_monitor.utils.time_utils.TimeFormatDetector.get_preference")
    def test_get_time_format_preference_with_args(self, mock_get_pref: Any) -> None:
...
class TestFormatDisplayTime:
    ...
    def test_format_display_time_24h_with_seconds(self, mock_pref: Any) -> None:
    ...
    @patch("claude_monitor.utils.time_utils.get_time_format_preference")
    def test_format_display_time_24h_without_seconds(self, mock_pref: Any) -> None:
    ...
    @patch("claude_monitor.utils.time_utils.get_time_format_preference")
    def test_format_display_time_12h_with_seconds(self, mock_pref: Any) -> None:
    ...
    @patch("claude_monitor.utils.time_utils.get_time_format_preference")
    def test_format_display_time_12h_without_seconds(self, mock_pref: Any) -> None:
    ...
    @patch("claude_monitor.utils.time_utils.get_time_format_preference")
    def test_format_display_time_auto_preference(self, mock_pref: Any) -> None:
...
class TestFormattingErrorHandling:
    ...
    def test_format_display_time_invalid_inputs(self) -> None:
        ...
        # Test with invalid datetime - skip None test due to type annotation
        # The function properly requires a datetime object
        pass
...
class TestModelUtils:
    ...
    def test_normalize_model_name(self) -> None:
        ...
        # Note: normalize_model_name expects str, not None
