...
def get_default_data_paths() -> List[str]:
    ...
    Docker-friendly implementation with comprehensive fallback.

    Returns:
        List of data paths to use as defaults
    """
    # Check environment variable first (comma or colon-separated paths)
    ...
    # Docker-specific check: if /data exists and contains .jsonl files, use it
